...
public class RequisitionContractItemView extends VBox {
    public RequisitionContractItemView() {
        Label label = new Label("This is the Requisition Contract Item View");
